...
plot.tot.cases.my <- ggplot(tot_cases_my, aes(x = date, y = total_cases)) +
  ...
  scale_y_continuous(labels = comma,
                     breaks = seq(0, max(tot_cases_my$total_cases), 25)) + # change axis from scientific notion to comma style
  xlab("Date") + ylab("No. of Total Cases") # relabel axis
...
plot.total.new_cases_my <- ggplot(tot_new_cases_my, aes(x = date, y = new_cases)) +
  ...
  scale_y_continuous(labels = comma,
                     breaks = seq(0, max(tot_new_cases_my$new_cases, 
                                         na.rm = T), 10)) + # change axis from scientific notion to comma style
